...
let alphabetLetters = alphabetString.split('');
console.log(alphabetLetters)

let sassyString = "That wasn't anywhere in the lesson..."

let sassyArray = sassyString.split('');
console.log(sassyArray)
...
console.log(reverseAlphabet.join())
...
myTodoList.push('homework')
myTodoList.push('clean up')
myTodoList.push('baby bedime!')
...
let yourTodoList = ['feed cats', 'feed dog']
