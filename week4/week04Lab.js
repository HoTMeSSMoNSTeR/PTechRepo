...
const whatEat = "nachos"
const whatDrink = "mountain dew"

let myName = "Nichole"
let bestFriend = "Calli"

//Question: Name a reason why you would use const instead of let.
//Answer: const is used for a variable that will not change. Anything that won't change or that needs to stay
// consistant should be a const. Let is for variables that may need to change. Like if it's dependant on an input
...
let bestfFriendlunch = `For lunch today, ${myName} and ${bestFriend} are eating ${whatEat}, and 
   washing it down with a cool ${whatDrink}!`
console.log(bestfFriendlunch)
//Question: How would the sentence you wrote look if you used string concatenation instead of template literals?
console.log("For lunch today " + myName + " and " + bestFriend + " are eating " + whatEat + ", and washing it down with a cool " + whatDrink + "!")
//Answer:
console.log(`-------------------------- 
Question 2a: Oh no`)
